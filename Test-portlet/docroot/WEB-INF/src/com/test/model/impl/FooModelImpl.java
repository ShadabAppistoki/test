...
public class FooModelImpl extends BaseModelImpl<Foo> implements FooModel {
	...
	public static final String TABLE_SQL_CREATE = "create table TEST_Foo (fooId LONG not null primary key,groupId LONG,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,field1 VARCHAR(75) null,field2 BOOLEAN,field3 INTEGER,field4 DATE null,field5 VARCHAR(75) null)";
